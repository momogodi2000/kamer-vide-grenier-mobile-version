...
import { createProduct, getCategories } from '../../store/slices/productSlice';
import { Button, Card, TextInput } from '../../components/ui';
import { colors, typography, spacing, borderRadius } from '../../theme';
import { Region, DeliveryOptions, ProductCondition } from '../../models';
...
const CreateProductScreen: React.FC = () => {
  ...
  const [formData, setFormData] = useState<ProductFormData>({
    ...
    images: [],
    city: user?.city || '',
    region: (user?.region as Region) || 'Centre',
    location: '',
    delivery_options: {
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Créer un produit</Text>
        <View style={styles.headerSpacer} />
      </View>
